...
const PurchaseList = () => {
 ...
 const handleEditClick = (item) => {
  setEditingItemId(item.id); // Set the item being edited
  setEditItemData({ ...item }); // Set current item data
};
...
const saveEdit = async () => {
  try {
    await AxiosInstance.put(`/purchase-items/${editingItemId}/`, editItemData);
        ...
        <tbody>
          {group.purchases.flatMap((purchase, i) =>
            purchase.items.map((item, j) => {
              ...
              return (
                <tr key={item.id}>
                  <td className="border p-2">{i + j + 1}</td>
                  ...
                  {isEditing ? (
                    <>
                      ...
                      <td className="border p-2">
                        <input
                          type="number"
                          name="only_sheet_or_piece"
                          className="w-full p-1 border rounded"
                          value={editItemData.only_sheet_or_piece}
                          onChange={handleEditChange}
                        />
                      </td>
                      <td className="border p-2">
                        <input
                          ...
                          className="w-full p-1 border rounded"
                          value={editItemData.total_sheet_or_piece}
                          onChange={handleEditChange}
                        />
                      </td>
                      <td className="border p-2">
                      ...
                      <td className="border p-2">
                        <input
                          ...
                          className="w-full p-1 border rounded"
                          value={editItemData.additional_cost}
                          onChange={handleEditChange}
                        />
                      </td>
                      <td className="border p-2">
                      ...
                      <td className="border p-2">
                        <input
                          ...
                          className="w-full p-1 border rounded"
                          value={editItemData.per_sheet_or_piece_sell_price}
                          onChange={handleEditChange}
                        />
                      </td>
                      <td className="border p-2">
                        {(
                          editItemData.total_sheet_or_piece *
                          editItemData.purchase_price
                        ).toFixed(2)}
                      </td>
                      <td className="border p-2">
                        <button
